...
export function SignUp() {
    ...
    return (
        <form onSubmit={onSubmit} className="w-full flex flex-col gap-4">
            ...
            <Input required legend="Senha" type="password" placeholder="Sua Senha" onChange={(e) => setPassword(e.target.value)} />
            <Input required legend="Confirmação da Senha" type="password" placeholder="Confirme sua Senha" onChange={(e) => setPasswordConfirm(e.target.value)} />
